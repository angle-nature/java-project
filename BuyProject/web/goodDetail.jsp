...
<body>
 <h1>商品详情</h1>
    ...
    <center>
      ...
      <div id="cart">
               <img src="images/buy_now.png"><a onclick="selflog_show(<%=item.getId()%>)" href=""><img src="images/in_cart.png"></a><a href="servlet/Cartservlet?action=show"><img src="images/view_cart.jpg"/></a>
             </div>
